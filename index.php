		...
		<div class="container">
                <div class="meta-post">
					...
					<div class="row">
						...
						<div class="col mb-4">
							<div class="card" style="width: 16rem;">
                                <img src="foto_produk/<?php echo $perproduk['foto_produk']; ?>" class="card-img-top" style="width : 100%; height: 180px;">                            
								<div class="card-body">
					...
					<div class="row justify-content-md-center">
						<div class="col">
							<div class="article-container-secondRow text-uppercase">
								<a href="view/client/shopCategory.php?kategori=<?= $table = 'bola'; ?>" style="text-decoration: none;">
						...
						<div class="col ">
							<div class="article-container-secondRow text-uppercase">
								<a href="view/client/shopCategory.php?kategori=<?= $table = 'futsal'; ?>" style="text-decoration: none;">
						...
						<div class="col ">
							<div class="article-container-secondRow text-uppercase">
								<a href="view/client/shopCategory.php?kategori=<?= $table = 'running'; ?>" style="text-decoration: none;">
					...
					<div class="row justify-content-md-center">
						<div class="col">
							<div class="article-container-secondRow text-uppercase">
								<a href="view/client/shopCategory.php?kategori=<?= $table = 'sneaker'; ?>" style="text-decoration: none;">
						...
						<div class="col ">
							<div class="article-container-secondRow text-uppercase">
								<a href="view/client/shopCategory.php?kategori=<?= $table = 'voli'; ?>" style="text-decoration: none;">
						...
						<div class="col ">
							<div class="article-container-secondRow text-uppercase">
								<a href="view/client/shopCategory.php?kategori=<?= $table = 'basket'; ?>" style="text-decoration: none;">
